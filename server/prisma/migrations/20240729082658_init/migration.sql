...
CREATE TABLE `Scrap` (
    ...
    UNIQUE INDEX `Scrap_scrapperId_scrapPlaceId_key`(`scrapperId`, `scrapPlaceId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Scrap` ADD CONSTRAINT `Scrap_scrapperId_fkey` FOREIGN KEY (`scrapperId`) REFERENCES `User`(`email`) ON DELETE CASCADE ON UPDATE CASCADE;
